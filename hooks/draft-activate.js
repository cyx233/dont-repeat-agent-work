...
3. Session overrides: if the user says "never cache" or "stop offering saves" — suppress all save/note offers for the rest of the session. If "always cache" — auto-save without asking.`;
